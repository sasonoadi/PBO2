...
class Truk(Mobil):
    ...
    def get_kapasitas(self): return self.kapasitas
...
MotorListrikA = MotorListrik ('Gesits', 'Gesit Electric', '5KW')
print('Nama\t  : ',MotorListrikA.get_nama())
print('Tipe\t  : ',MotorListrikA.get_tipe())
print('Kapasitas : ',MotorListrikA.get_daya())