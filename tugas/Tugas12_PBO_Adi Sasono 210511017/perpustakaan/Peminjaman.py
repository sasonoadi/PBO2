...
class Peminjaman:
    ...
    def id(self):
        return self.__id
    @property
    def code_pinjam(self):
        return self.__code_pinjam
        
    @code_pinjam.setter
    def code_pinjam(self, value):
        self.__code_pinjam = value
    @property
    ...
    def get_by_code_pinjam(self, code_pinjam):
        url = self.__url+"?code_pinjam="+code_pinjam
        payload = {}
        headers = {'Content-Type': 'application/json'}
        ...
        for item in data:
            ...
            self.__code_pinjam = item['code_pinjam']
    ...
    def simpan(self):
        payload = {
            "code_pinjam":self.__code_pinjam,
        ...
        return response.text
    def update_by_code_pinjam(self, code_pinjam):
        url = self.__url+"?code_pinjam="+code_pinjam
        payload = {
            "code_pinjam":self.__code_pinjam,
            "tanggal_kembali":self.__tanggal_kembali,
        ...
        return response.text
    def delete_by_code_pinjam(self,code_pinjam):
        url = self.__url+"?code_pinjam="+code_pinjam
        headers = {'Content-Type': 'application/json'}
        payload={}
